...
exists_warning SBATCH_ARGS "additional arguments to sbatch job submit command" "--time=01:00:00"
...
var_args=
for var in EXPORT_DEST INPUT_SOURCE DOCKFILES DOCKEXEC SHRTCACHE LONGCACHE SHRTCACHE_USE_ENV; do
	export $var
	echo "$var=${!var}"
done
...
sbatch $SBATCH_ARGS --signal=B:USR1@120 --array=1-$njobs $BINDIR/rundock.bash
